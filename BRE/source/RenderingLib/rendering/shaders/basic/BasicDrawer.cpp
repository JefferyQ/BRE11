...
namespace BRE {
	void BasicDrawer::Draw(ID3D11Device1& device, ID3D11DeviceContext1& context, ID3D11RenderTargetView* geometryBuffersRTVs[6], const XMMATRIX& view, const XMMATRIX& proj, const float farClipPlaneDistance) {
