#include "InverseColorFilterPsData.h"
...
namespace {
	const char* sShaderFile = "content\\shaders\\InverseColorFilterPS.cso";
}
...
namespace BRE {
	...
	void InverseColorFilterPsData::PostDraw(ID3D11DeviceContext1& context) {
