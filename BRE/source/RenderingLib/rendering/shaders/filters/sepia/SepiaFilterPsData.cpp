...
namespace {
	const char* sShaderFile = "content\\shaders\\filters\\sepia\\SepiaFilterPS.cso";
}

namespace BRE {
	SepiaFilterPsData::SepiaFilterPsData()
	...
	void SepiaFilterPsData::PreDraw(ID3D11Device1& /*device*/, ID3D11DeviceContext1& context) {
		// Set shader
		BRE_ASSERT(mShader);
	...
	void SepiaFilterPsData::PostDraw(ID3D11DeviceContext1& context) {
