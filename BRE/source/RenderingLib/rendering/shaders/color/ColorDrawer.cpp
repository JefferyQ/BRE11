...
namespace BRE {
	void ColorDrawer::Draw(ID3D11Device1& device, ID3D11DeviceContext1& context, ID3D11RenderTargetView* geometryBuffersRTVs[4], const XMMATRIX& view, const XMMATRIX& proj, const float farClipPlaneDistance) {
