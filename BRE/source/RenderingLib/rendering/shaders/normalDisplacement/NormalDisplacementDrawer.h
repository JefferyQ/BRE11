...
namespace BRE {
		...
		public:
			...
			void Draw(ID3D11Device1& device, ID3D11DeviceContext1& context, ID3D11RenderTargetView* geometryBuffersRTVs[4], const DirectX::XMMATRIX& view, const DirectX::XMMATRIX& proj);
